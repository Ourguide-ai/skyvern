export const baseHelpTooltipContent = {
  url: "The URL Argide is navigating to. Leave this field blank to pick up from where the last block left off.",
  navigationGoal:
    "Give Argide an objective. Make sure to include when the block is complete, when it should self-terminate, and any guardrails. Use {{ parameter_name }} to reference an input value",
  parameters:
    'Define placeholder values using the "inputs" drop down that you predefine or redefine run-to-run.',
  dataExtractionGoal:
    "Tell Argide what data you would like to scrape at the end of your run.",
  ...
  completeOnDownload:
    "Allow Argide to auto-complete the block when it downloads a file.",
  fileSuffix:
  ...
  engine:
    "Argide 1.0 is the default for new browser tasks. Existing V2 blocks remain supported.",
} as const;

export const basePlaceholderContent = {
  url: "(optional) Navigate to this URL: https://...",
  navigationGoal: "Tell Argide what to do.",
...
export const helpTooltips = {
  ...
  extraction: {
    ...baseHelpTooltipContent,
    dataExtractionGoal:
      "Tell Argide what data you would like to scrape. Use {{ parameter_name }} to specify inputs to use.",
  },
  action: {
    ...baseHelpTooltipContent,
    navigationGoal:
...
export const placeholders = {
  ...
  fileDownload: {
    navigationGoal: "Tell Argide which file to download.",
  },
